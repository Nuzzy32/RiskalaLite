  ...
  Future<void> _assignPsikolog(int psikologId) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Penugasan ke ${psikolog?['nama'] ?? 'psikolog'} berhasil. Email terkirim.'),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          riskLabel,
                          style: TextStyle(
                            fontFamily: 'NimbusSans', fontSize: 9,
                            fontWeight: FontWeight.w700,
                            color: badgeText, letterSpacing: 0.5,
                          ),
                        ),
                      ),
                    ],
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('Weekly Stress Assessment',
                style: TextStyle(
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text('${level.round()}/5',
                      style: const TextStyle(
                          fontFamily: 'NimbusSans', fontSize: 12,
                          fontWeight: FontWeight.w700, color: Color(0xFF60D0DC))),
                ),
              ],
            ),
            const SizedBox(height: 16),
            SliderTheme(
              ...
              child: Slider(
                value: level, min: 1, max: 5, divisions: 4, onChanged: null,
              ),
            ),
            const Padding(
              ...
              child: Row(
                ...
                children: [
                  Text('RENDAH',
                      style: TextStyle(
                          fontFamily: 'NimbusSans', fontSize: 10,
                          fontWeight: FontWeight.w500, color: Color(0xFF7A8B94),
                          letterSpacing: 0.5)),
                  Text('TINGGI',
                      style: TextStyle(
                          fontFamily: 'NimbusSans', fontSize: 10,
  ...
  Widget _buildIncidentSection() {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Komentar Karyawan & Laporan Insiden',
              style: TextStyle(
                  fontFamily: 'Manrope', fontSize: 16,
                  fontWeight: FontWeight.w700, color: Color(0xFF245A72))),
          ...
          Container(
            ...
            child: Text(widget.kategori ?? '-',
                style: const TextStyle(
                    fontFamily: 'NimbusSans', fontSize: 12,
                    fontWeight: FontWeight.w600, color: Color(0xFF245A72))),
          ),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                const Icon(Icons.check_circle, size: 18, color: Color(0xFF166534)),
                const SizedBox(width: 8),
                const Text('Sudah Ditugaskan ke Psikolog',
                    style: TextStyle(
            ...
            Container(
              ...
              child: Row(
                children: [
                  const Icon(Icons.mark_email_read_outlined, size: 14, color: Color(0xFF166534)),
                  const SizedBox(width: 6),
                  Expanded(
                    child: Text('Email penugasan otomatis terkirim ke psikolog.',
                        style: TextStyle(
                            fontFamily: 'NimbusSans', fontSize: 11,
    ...
    if (isDone) {
      return Padding(
        ...
        child: Container(
          ...
          child: const Text('Sudah Ditindaklanjuti',
        ...
        child: Column(
          children: [
            ...
            TextButton.icon(
              ...
              label: const Text('Ganti Psikolog',
                  style: TextStyle(
                      fontFamily: 'NimbusSans', fontSize: 13,
                      fontWeight: FontWeight.w600)),
    ...
    return Padding(
      ...
      child: SizedBox(
        ...
        child: ElevatedButton.icon(
          ...
          label: Text(_saving ? 'Memproses…' : 'Tindak Lanjut → Pilih Psikolog',
              style: const TextStyle(
                  fontFamily: 'NimbusSans', fontSize: 15,
...
class _PsikologPickerSheetState extends State<_PsikologPickerSheet> {
  ...
  @override
  Widget build(BuildContext context) {
    final available = _psikologs.where((p) => p['is_available'] == true).toList();
    final unavailable = _psikologs.where((p) => p['is_available'] != true).toList();
        ...
        child: Column(
          children: [
            ...
            const Padding(
              ...
              child: Row(
                children: [
                  Icon(Icons.psychology_outlined, color: Color(0xFF245A72), size: 22),
                  SizedBox(width: 10),
                  Text('Pilih Psikolog',
                      style: TextStyle(
                          fontFamily: 'Manrope', fontSize: 18,
  ...
  Widget _buildEmpty() => Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.psychology_outlined, size: 48,
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  child: Text(available ? 'Available' : 'Penuh',
                      style: TextStyle(
                          fontFamily: 'NimbusSans', fontSize: 10,
                          fontWeight: FontWeight.w700,
                          color: available
